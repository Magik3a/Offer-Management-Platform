...
(function (OMP) {
    ...
    (function (Offers) {
        var CountriesGrid = /** @class */ (function (_super) {
            ...
            CountriesGrid.prototype.onViewProcessData = function (response) {
                var listResponse = _super.prototype.onViewProcessData.call(this, response);
                console.log(response);
                Offers.CountriesService.RetrieveLocalization({
                    EntityId: 1
