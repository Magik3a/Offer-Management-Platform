namespace OMP.Texts {
    ...
    declare namespace Db {
        ...
        namespace Offers {
            ...
            namespace Companies {
                ...
                export const CityName: string;
                export const CompanyId: string;
                export const CompanyWebSites: string;
                export const InsertDate: string;
                export const InsertUserId: string;
                export const InsertUserName: string;
                export const IsActive: string;
            ...
            namespace CompanyWebSites {
                export const CompanyAdditionalInfo: string;
                export const CompanyAddress: string;
                export const CompanyCityId: string;
                export const CompanyId: string;
                export const CompanyName: string;
                export const CompanyPhone: string;
                export const CompanyPrimaryAccountId: string;
                export const CompanyWebSiteId: string;
                export const InsertDate: string;
                export const InsertUserId: string;
                export const InsertUserName: string;
                export const IsActive: string;
            ...
            namespace OfferAttachments {
                ...
                export const OfferAttachmentId: string;
            ...
            namespace OfferCategoryTasks {
                ...
                export const OfferCategoryId: string;
                export const OfferCategoryOfferId: string;
                export const OfferCategoryOrder: string;
                export const OfferCategoryPrice: string;
            ...
            namespace OfferStatuses {
                ...
                export const CountForCompleted: string;
                export const InsertDate: string;
                export const InsertUserId: string;
                export const InsertUserName: string;
                export const IsActive: string;
            ...
            namespace Offers {
                ...
                export const Name: string;
                export const NotCompletedTasks: string;
                export const NoteList: string;
                export const OfferId: string;
                export const OfferStatusBackgroundColor: string;
                export const OfferStatusBorderColor: string;
                ...
                export const OfferStatusName: string;
                export const Price: string;
                export const SoftwareFrameworkBackgroundColor: string;
                export const SoftwareFrameworkBorderColor: string;
                export const SoftwareFrameworkId: string;
                export const SoftwareFrameworkName: string;
            ...
            namespace SoftwareFrameworks {
                ...
                export const NoteList: string;
                export const SoftwareFrameworkId: string;
                export const SpecificVersion: string;
                export const UpdateDate: string;
                export const UpdateUserId: string;
                export const UpdateUserName: string;
            }
            ...
            namespace UserOfferSettings {
                export const InsertDate: string;
                export const InsertUserId: string;
                export const InsertUserName: string;
                export const IsActive: string;
                export const NoteList: string;
                export const OfferInvoiceAdditionalInfoFormatter: string;
                export const OfferInvoiceFooterImage: string;
                export const OfferInvoiceFooterText: string;
                export const UpdateDate: string;
                export const UpdateUserId: string;
                export const UpdateUserName: string;
                export const UserId: string;
                export const UserName: string;
                export const UserOfferSettingId: string;
            }

            namespace UserOfferSettingsLang {
                export const Id: string;
                export const LanguageId: string;
                export const OfferInvoiceAdditionalInfoFormatter: string;
                export const OfferInvoiceFooterImage: string;
                export const OfferInvoiceFooterText: string;
                export const UserOfferSettingId: string;
                export const UserOfferSettingOfferInvoiceAdditionalInfoFormatter: string;
                export const UserOfferSettingOfferInvoiceFooterImage: string;
                export const UserOfferSettingOfferInvoiceFooterText: string;
                export const UserOfferSettingUserId: string;
            }
        }
    }
    ...
    declare namespace Site {
        ...
        export const GroupingButtonFormatterOneValue: string;
        export const GroupingButtonFormatterTwoValues: string;
        export const GroupingItemsFormatter: string;
        ...
        export const NoGroupingButton: string;

        namespace Offers {
            export const OfferReportPage: string;
            export const OfferReportTotalPrice: string;
            export const ValidationErrorMaximumDays: string;
        }
